...
const Bebidas = () => {
  return (
    <div className="pt-[90px] w-full dark:bg-zinc-900">
      <div className="relative h-[calc(100svh-20rem)] sm:h-[calc(100svh-10rem)]">
        <div className="absolute z-40 h-[calc(100svh-20rem)] sm:h-[calc(100svh-10rem)] inset-0 bg-black opacity-60" />
        <span className="absolute z-50 flex items-center justify-center w-full h-[calc(100svh-20rem)] sm:h-[calc(100svh-10rem)] text-5xl sm:text-7xl text-white font-bold">
          Bebidas
        </span>
        <div
          className="relative w-full h-[calc(100svh-20rem)] sm:h-[calc(100svh-10rem)]"
      ...
      <div className="bg-[url('/Images/Luces.webp')] object-cover bg-center h-36"/>
          <div id="refrescos-section" className="sm:py-5 w-full text-center text-3xl md:text-5xl lg:text-6xl text-white font-bold py-4">
          ...
          <div id="cervezas-section" className="sm:py-5 w-full text-center text-3xl md:text-5xl lg:text-6xl text-white font-bold py-4">
          ...
          <div id="licores-section" className="w-full py-5 text-center text-3xl md:text-5xl lg:text-6xl text-white font-bold">
            <div className="flex justify-center">
              <span className="bg-red-800 p-1 px-4 lg:p-4 lg:px-8">
                Licores
              </span>
